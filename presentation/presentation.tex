...
\begin{figure}
	\includegraphics[scale=0.5]{frequent-items/fi1}
	\label{fig:fi1}
\end{figure}
...
\begin{figure}
	\includegraphics[scale=0.5]{frequent-items/fi2}
	\label{fig:fi2}
\end{figure}
...
\begin{figure}
	\includegraphics[scale=0.5]{frequent-items/fi3}
	\label{fig:fi3}
\end{figure}
...
\begin{figure}
	\includegraphics[scale=0.5]{frequent-items/fi4}
	\label{fig:fi4}
\end{figure}
...
\begin{figure}
	\includegraphics[scale=0.5]{frequent-items/fi6}
	\label{fig:fi5}
\end{figure}
...
\begin{figure}
	\includegraphics[scale=0.5]{frequent-items/fi7}
	\label{fig:fi7}
\end{figure}
...
\begin{figure}
	\includegraphics[scale=0.5]{frequent-items/fi8}
	\label{fig:fi8}
\end{figure}
...
\begin{figure}
	\includegraphics[scale=0.5]{frequent-items/fi9}
	\label{fig:fi9}
\end{figure}
...
\begin{figure}
	\includegraphics[scale=0.5]{frequent-items/fi10}
	\label{fig:fi10}
\end{figure}
...
\framebreak
Represent the \textcolor{dgreen}{frequency} of a row (direction):
\begin{itemize}
  \item Assume rows of $A$ are \textcolor{red}{indicator vectors} of the items: \\
  \begin{center}
  \vspace{2 mm}
  $A = \begin{pmatrix}
       1 & 0 & 0 & 0\\[0.3em] 
  ...
  \item Generalize the rows (directions) to $\{x : \vectornorm{x}=1\} $ and the \textcolor{dgreen}{frequency} of a direction is $\vectornorm{Ax}^2$.
\end{itemize}
